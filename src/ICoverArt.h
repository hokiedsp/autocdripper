...
public:
     ...
     *  @param[in]  record index (default=0)
     */
    virtual void FrontData(std::vector<unsigned char> &data, const int recnum=0) const=0;
     ...
     *  @param[in]  record index (default=0)
     */
    virtual void BackData(std::vector<unsigned char> &data, const int recnum=0) const=0;
