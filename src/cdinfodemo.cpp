    ...
    try
    {
        ...
        */
        ...
        if (nmatches>0)
        {
            ...
            if (mb5.Front(nmatches-1) && (ImageData=mb5.FrontData(nmatches-1)).size())
            {
                std::string FileName = "front.jpg";
                cout << "Saving front to '" << FileName << "'" << std::endl;
            ...
            {
                cout << "CoverArt Archive could not locate any coverart for this CD.";
            }
        }
    }
    catch (exception& e)
